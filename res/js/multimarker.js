...
AFRAME.registerComponent('videoEvent0', {
            init: function() {
                var marker = this.el;
                ...
                marker.addEventListener('markerFound', function() {
                    ...
                    document.querySelector('#vid0').setAttribute('visible', true);
                    ...
                    vid.addEventListener('ended', function(e) {
                        document.querySelector('#vid0').setAttribute('visible', false);
                    });
                });
            }
        });
...
AFRAME.registerComponent('videoEvent1', {
            init: function() {
                var marker = this.el;
...
AFRAME.registerComponent('videoEvent2', {
            init: function() {
                var marker = this.el;
                ...
                marker.addEventListener('markerFound', function() {
                    ...
                    // which will display the a-image element with the watch behind it
                    vid.addEventListener('ended', function(e) {
                        document.querySelector('#vid2').setAttribute('visible', false);
                    });
                });
            }
        });
